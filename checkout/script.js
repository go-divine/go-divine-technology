...
function proceedButton() {
  ...
  let serviceTitle = document.getElementById("service-title").innerHTML;
...
const myRequest = new Request(
  `https://crdquqf8.api.sanity.io/v2022-03-07/data/query/production?query=*%5B_type+%3D%3D+%22${checkOutCategory}%22%5D`
);
fetch(myRequest)
