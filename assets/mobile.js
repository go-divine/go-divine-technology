function displayServices({ title, pricing, serviceList, paymentUrl }) {
    ...
    <div class="service-price-card-${cardColorNumber}" style="list-style: none; margin-bottom: 40px;">
        ...
        <br></br>
        ${serviceList}
        <a href="../../checkout/?category=mobile&params=${title?.toLowerCase()}" target="_blank" class="service-price-button-${cardColorNumber} w-button">Proceed</a>
    </div>
    `;
...
function GetServiceLists({serviceList, cardIndex}) {
    var cardColorNumber = 'price-check-icon-two';
    // if (cardIndex == 0) {
